...
// Kiểm tra quyền thêm loại phòng
if (!checkPermission($conn, $userRole, 'add_room_type')) {
    echo "<script>alert('Bạn không có quyền thêm loại phòng!'); window.location.href='../dashboard/index.php';</script>";
    exit;
}
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row mb-4">
                            <div class="col-12">
                                <h4 class="mb-1">Thêm loại phòng</h4>
                            </div>
                        </div>
                        <?php if (!empty($errors)): ?>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form method="POST" action="process-add-type-room.php">
                                    <div class="row">
