...
if (!checkPermission($conn, $userRole, 'add_user')) {
    echo "<script>alert('Bạn không có quyền thêm người dùng!'); window.location.href='../dashboard/index.php';</script>";
    exit;
}
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h4 class="mb-1">Thêm mới người dùng</h4>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form id="formAccountSettings" method="POST" action="process-add-user.php"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select class="form-select" id="role" name="role"
                                                ...
                                                <option value="sinh_vien"
                                                    <?= (isset($old['role']) && $old['role']=='sinh_vien') ? 'selected' : '' ?>>
                                                    Sinh viên</option>
                                                <option value="giang_vien"
                                                    <?= (isset($old['role']) && $old['role']=='giang_vien') ? 'selected' : '' ?>>
                                                    Giảng viên</option>
                                            </select>
                                        </div>

                                        <div class="mb-3 col-md-6" id="student_code_field" style="display:none;">
                                        ...
                                        <div class="mb-3 col-md-6" id="employee_code_field" style="display:none;">
                                ...
                                // Hiển thị đúng field khi load lại trang
